...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var t=require("../core/index.js"),n=require("../utils/tools.js");function e(t){return o(t)||r(t)||i()}function i(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function r(t){if(Symbol.iterator in Object(t)||"[object Arguments]"===Object.prototype.toString.call(t))return Array.from(t)}function o(t){if(Array.isArray(t)){for(var n=0,e=new Array(t.length);n<t.length;n++)e[n]=t[n];return e}}function a(t,n){if(!(t instanceof n))throw new TypeError("Cannot call a class as a function")}function d(t,n){for(var e=0;e<n.length;e++){var i=n[e];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}function u(t,n,e){return n&&d(t.prototype,n),e&&d(t,e),t}var c=function(){function i(t,n){a(this,i);var e=n.data;this.nodes=this.initData(e),this.core={},this.init(t,n)}return u(i,[{key:"initData",value:function(t){if("Array"===(0,n.typeOf)(t))return t.map(function(t){return"position"in t||(t.position={x:50,y:50}),t});throw TypeError("".concat(t," is not Array"))}},{key:"init",value:function(n,e){var i=e.zoom,r=void 0!==i&&i,o=e.coreOptions,a=void 0===o?{}:o,d={linkDot:{display:"none"}};Object.assign(d,a,{mode:"render-mode"}),this.core=new t.Core(n,d),this.initialLayout(this.nodes),r&&this.core.zoom(n)}},{key:"initialLayout",value:function(t){var n=this,i=this.findRoot(t);-1===this.core.nodes.findIndex(function(t){return t.id===i.id})&&this.createNode(i);var r=t.filter(function(t){return t.parent===i.id}),o=[];r.forEach(function(t){if(t.parent===i.id&&t.children.length>0){var a=r.filter(function(n){return-1!==t.children.indexOf(n.id)}),d=n.findChilds(n.nodes,t);a=Array.from(new Set([t].concat(e(a),e(d)))),o.push(a)}});var a=0;r.forEach(function(t,e){var r=n.createNode(t),o=t.children.length;if(o>=1){var d=n.nodes.filter(function(n){if(-1!==t.children.indexOf(n.id))return n}).reduce(function(t,n){return n.children.length>0?t+n.children.length:t},0),u=n.getPosition(t,i,a);r.changePosition(u),a+=o>1?o+d:1}else{var c=n.getPosition(t,i,e);r.changePosition(c),a+=1}}),this.drawLink(r,i),o.length>0&&o.forEach(function(t){n.initialLayout(t)})}},{key:"findRoot",value:function(t){return t.find(function(n){if(n.children.length>0)return-1===t.findIndex(function(t){return n.parent===t.id})})}},{key:"findChilds",value:function(t,n){var i=this,r=[],o=t.filter(function(e){if(e.parent===n.id)return e.children.length>0&&(r=i.findChilds(t,e)),e});return Array.from(new Set([].concat(e(o),e(r))))}},{key:"getPosition",value:function(t,n,e){var i=t.width,r=t.height;if(0===i||0===r||void 0===i||void 0===r)throw Error('node must has "width" an "height" attributes');var o=2*i,a=2*r,d=n.position,u=d.x+o*e,c=d.y+a;return t.position={x:u,y:c},t.position}},{key:"createNode",value:function(n){var e='.item[data-rsgraph-id="'.concat(n.id,'"]'),i=document.querySelector(e),r=n.width,o=void 0===r?0:r,a=n.height,d=void 0===a?0:a,u=n.position;if(0===o||0===d||void 0===o||void 0===d)throw Error('node must has "width" an "height" attributes');var c=new t.Node({position:u,style:{width:o,height:d,userSelect:"none",rx:10},html:{meta:i}});return Object.assign(c,n),this.core.addNode(c),c}},{key:"drawLink",value:function(n,e){var i=this;n.forEach(function(n){var r=new t.Edge;i.core.addEdge(r,{source:e.id,target:n.id,dotLink:"bottom",dotEndLink:"top"})})}}]),i}();exports.default=c;
