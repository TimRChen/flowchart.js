...
"use strict";function t(){for(var t="ABCDEFGHJKMNPQRSTWXYZabcdefhijkmnprstwxyz2345678",e=t.length,r="",o=0;o<32;o++)r+=t.charAt(Math.floor(Math.random()*e));return r}function e(t){return Object.prototype.toString.call(t).slice(8,-1)}function r(t){return document.createElementNS("http://www.w3.org/2000/svg",t)}Object.defineProperty(exports,"__esModule",{value:!0}),exports.getRandomStr=t,exports.typeOf=e,exports.creatSvgElement=r;
},{}],"aLLG":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var t=require("../utils/tools.js");function e(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function i(t,e){for(var i=0;i<e.length;i++){var n=e[i];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}function n(t,e,n){return e&&i(t.prototype,e),n&&i(t,n),t}var r=function(){function i(){var n=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};e(this,i),this.id=(0,t.getRandomStr)(),this.source=0,this.target=0,this.lineData="",this.edge=this.createEdge(),this.dotLink="",this.dotEndLink="",this.watchProperty(),"style"in n&&Object.assign(this.edge.style,n.style)}return n(i,[{key:"watchProperty",value:function(){var t=this,e="";Object.defineProperty(this,"lineData",{enumerable:!0,get:function(){return e},set:function(i){e=i,t.setPath()}})}},{key:"setPath",value:function(){this.edge.setAttribute("d",this.lineData)}},{key:"createEdge",value:function(){var e=(0,t.creatSvgElement)("path");return e.setAttribute("class","link"),e.setAttribute("marker-end","url(#mark-arrow)"),e=this.initializeStyle(e)}},{key:"initializeStyle",value:function(t){return Object.assign(t.style,{fill:"none",stroke:"#000",strokeWidth:2,strokeLinejoin:"round"}),t}}]),i}();exports.default=r;
...
},{"./create":"aaeJ","./creator":"z8hd","./local":"iml1","./matcher":"oB3r","./mouse":"Y8+C","./namespace":"U3j5","./namespaces":"YeOr","./point":"/JEJ","./select":"RAQf","./selectAll":"zmwq","./selection/index":"G2fv","./selector":"vXaf","./selectorAll":"/t3J","./selection/style":"6Wec","./touch":"SZFU","./touches":"lhoo","./window":"6iFw","./selection/on":"pgiW"}],"a3oC":[function(require,module,exports) {
...
},{"./dispatch":"a3oC"}],"BxLv":[function(require,module,exports) {
...
},{"d3-selection":"//ys","./noevent.js":"BxLv"}],"qb7E":[function(require,module,exports) {
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=d;var e=require("d3-dispatch"),t=require("d3-selection"),n=a(require("./nodrag.js")),r=a(require("./noevent.js")),o=i(require("./constant.js")),u=i(require("./event.js"));function i(e){return e&&e.__esModule?e:{default:e}}function a(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var n in e)if(Object.prototype.hasOwnProperty.call(e,n)){var r=Object.defineProperty&&Object.getOwnPropertyDescriptor?Object.getOwnPropertyDescriptor(e,n):{};r.get||r.set?Object.defineProperty(t,n,r):t[n]=e[n]}return t.default=e,t}function c(){return!t.event.ctrlKey&&!t.event.button}function f(){return this.parentNode}function l(e){return null==e?{x:t.event.x,y:t.event.y}:e}function s(){return navigator.maxTouchPoints||"ontouchstart"in this}function d(){var i,a,d,p,v=c,h=f,g=l,y=s,m={},b=(0,e.dispatch)("start","drag","end"),j=0,w=0;function O(e){e.on("mousedown.drag",q).filter(y).on("touchstart.drag",T).on("touchmove.drag",_).on("touchend.drag touchcancel.drag",M).style("touch-action","none").style("-webkit-tap-highlight-color","rgba(0,0,0,0)")}function q(){if(!p&&v.apply(this,arguments)){var e=k("mouse",h.apply(this,arguments),t.mouse,this,arguments);e&&((0,t.select)(t.event.view).on("mousemove.drag",P,!0).on("mouseup.drag",x,!0),(0,n.default)(t.event.view),(0,r.nopropagation)(),d=!1,i=t.event.clientX,a=t.event.clientY,e("start"))}}function P(){if((0,r.default)(),!d){var e=t.event.clientX-i,n=t.event.clientY-a;d=e*e+n*n>w}m.mouse("drag")}function x(){(0,t.select)(t.event.view).on("mousemove.drag mouseup.drag",null),(0,n.yesdrag)(t.event.view,d),(0,r.default)(),m.mouse("end")}function T(){if(v.apply(this,arguments)){var e,n,o=t.event.changedTouches,u=h.apply(this,arguments),i=o.length;for(e=0;e<i;++e)(n=k(o[e].identifier,u,t.touch,this,arguments))&&((0,r.nopropagation)(),n("start"))}}function _(){var e,n,o=t.event.changedTouches,u=o.length;for(e=0;e<u;++e)(n=m[o[e].identifier])&&((0,r.default)(),n("drag"))}function M(){var e,n,o=t.event.changedTouches,u=o.length;for(p&&clearTimeout(p),p=setTimeout(function(){p=null},500),e=0;e<u;++e)(n=m[o[e].identifier])&&((0,r.nopropagation)(),n("end"))}function k(e,n,r,o,i){var a,c,f,l=r(n,e),s=b.copy();if((0,t.customEvent)(new u.default(O,"beforestart",a,e,j,l[0],l[1],0,0,s),function(){return null!=(t.event.subject=a=g.apply(o,i))&&(c=a.x-l[0]||0,f=a.y-l[1]||0,!0)}))return function d(p){var v,h=l;switch(p){case"start":m[e]=d,v=j++;break;case"end":delete m[e],--j;case"drag":l=r(n,e),v=j}(0,t.customEvent)(new u.default(O,p,a,e,v,l[0]+c,l[1]+f,l[0]-h[0],l[1]-h[1],s),s.apply,s,[p,o,i])}}return O.filter=function(e){return arguments.length?(v="function"==typeof e?e:(0,o.default)(!!e),O):v},O.container=function(e){return arguments.length?(h="function"==typeof e?e:(0,o.default)(e),O):h},O.subject=function(e){return arguments.length?(g="function"==typeof e?e:(0,o.default)(e),O):g},O.touchable=function(e){return arguments.length?(y="function"==typeof e?e:(0,o.default)(!!e),O):y},O.on=function(){var e=b.on.apply(b,arguments);return e===b?O:e},O.clickDistance=function(e){return arguments.length?(w=(e=+e)*e,O):Math.sqrt(w)},O}
},{"d3-dispatch":"D3zY","d3-selection":"//ys","./nodrag.js":"m07T","./noevent.js":"BxLv","./constant.js":"CjNr","./event.js":"qb7E"}],"kkdU":[function(require,module,exports) {
...
},{"./constant":"CjNr"}],"rvVK":[function(require,module,exports) {
...
},{"d3-color":"Peej","./rgb":"rvVK","./array":"TYZM","./date":"jEDF","./number":"YNf8","./object":"iJdZ","./string":"nK0E","./constant":"CjNr"}],"B1w8":[function(require,module,exports) {
...
},{"./selection/index":"vGqA","./transition/index":"OWOq","./active":"UWV/","./interrupt":"fDNN"}],"UMU7":[function(require,module,exports) {
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=y;var t=require("d3-dispatch"),e=require("d3-drag"),n=require("d3-interpolate"),o=require("d3-selection"),i=require("d3-transition"),u=c(require("./constant.js")),r=c(require("./event.js")),s=require("./transform.js"),h=a(require("./noevent.js"));function a(t){if(t&&t.__esModule)return t;var e={};if(null!=t)for(var n in t)if(Object.prototype.hasOwnProperty.call(t,n)){var o=Object.defineProperty&&Object.getOwnPropertyDescriptor?Object.getOwnPropertyDescriptor(t,n):{};o.get||o.set?Object.defineProperty(e,n,o):e[n]=t[n]}return e.default=t,e}function c(t){return t&&t.__esModule?t:{default:t}}function l(){return!o.event.ctrlKey&&!o.event.button}function f(){var t=this;return t instanceof SVGElement?(t=t.ownerSVGElement||t).hasAttribute("viewBox")?[[(t=t.viewBox.baseVal).x,t.y],[t.x+t.width,t.y+t.height]]:[[0,0],[t.width.baseVal.value,t.height.baseVal.value]]:[[0,0],[t.clientWidth,t.clientHeight]]}function m(){return this.__zoom||s.identity}function p(){return-o.event.deltaY*(1===o.event.deltaMode?.05:o.event.deltaMode?1:.002)}function v(){return navigator.maxTouchPoints||"ontouchstart"in this}function d(t,e,n){var o=t.invertX(e[0][0])-n[0][0],i=t.invertX(e[1][0])-n[1][0],u=t.invertY(e[0][1])-n[0][1],r=t.invertY(e[1][1])-n[1][1];return t.translate(i>o?(o+i)/2:Math.min(0,o)||Math.max(0,i),r>u?(u+r)/2:Math.min(0,u)||Math.max(0,r))}function y(){var a,c,y=l,_=f,z=d,g=p,w=v,x=[0,1/0],b=[[-1/0,-1/0],[1/0,1/0]],M=250,T=n.interpolateZoom,k=(0,t.dispatch)("start","zoom","end"),q=500,j=150,O=0;function P(t){t.property("__zoom",m).on("wheel.zoom",G).on("mousedown.zoom",K).on("dblclick.zoom",S).filter(w).on("touchstart.zoom",A).on("touchmove.zoom",H).on("touchend.zoom touchcancel.zoom",W).style("touch-action","none").style("-webkit-tap-highlight-color","rgba(0,0,0,0)")}function E(t,e){return(e=Math.max(x[0],Math.min(x[1],e)))===t.k?t:new s.Transform(e,t.x,t.y)}function D(t,e,n){var o=e[0]-n[0]*t.k,i=e[1]-n[1]*t.k;return o===t.x&&i===t.y?t:new s.Transform(t.k,o,i)}function V(t){return[(+t[0][0]+ +t[1][0])/2,(+t[0][1]+ +t[1][1])/2]}function Y(t,e,n){t.on("start.zoom",function(){B(this,arguments).start()}).on("interrupt.zoom end.zoom",function(){B(this,arguments).end()}).tween("zoom",function(){var t=arguments,o=B(this,t),i=_.apply(this,t),u=null==n?V(i):"function"==typeof n?n.apply(this,t):n,r=Math.max(i[1][0]-i[0][0],i[1][1]-i[0][1]),h=this.__zoom,a="function"==typeof e?e.apply(this,t):e,c=T(h.invert(u).concat(r/h.k),a.invert(u).concat(r/a.k));return function(t){if(1===t)t=a;else{var e=c(t),n=r/e[2];t=new s.Transform(n,u[0]-e[0]*n,u[1]-e[1]*n)}o.zoom(null,t)}})}function B(t,e,n){return!n&&t.__zooming||new X(t,e)}function X(t,e){this.that=t,this.args=e,this.active=0,this.extent=_.apply(t,e),this.taps=0}function G(){if(y.apply(this,arguments)){var t=B(this,arguments),e=this.__zoom,n=Math.max(x[0],Math.min(x[1],e.k*Math.pow(2,g.apply(this,arguments)))),u=(0,o.mouse)(this);if(t.wheel)t.mouse[0][0]===u[0]&&t.mouse[0][1]===u[1]||(t.mouse[1]=e.invert(t.mouse[0]=u)),clearTimeout(t.wheel);else{if(e.k===n)return;t.mouse=[u,e.invert(u)],(0,i.interrupt)(this),t.start()}(0,h.default)(),t.wheel=setTimeout(function(){t.wheel=null,t.end()},j),t.zoom("mouse",z(D(E(e,n),t.mouse[0],t.mouse[1]),t.extent,b))}}function K(){if(!c&&y.apply(this,arguments)){var t=B(this,arguments,!0),n=(0,o.select)(o.event.view).on("mousemove.zoom",function(){if((0,h.default)(),!t.moved){var e=o.event.clientX-r,n=o.event.clientY-s;t.moved=e*e+n*n>O}t.zoom("mouse",z(D(t.that.__zoom,t.mouse[0]=(0,o.mouse)(t.that),t.mouse[1]),t.extent,b))},!0).on("mouseup.zoom",function(){n.on("mousemove.zoom mouseup.zoom",null),(0,e.dragEnable)(o.event.view,t.moved),(0,h.default)(),t.end()},!0),u=(0,o.mouse)(this),r=o.event.clientX,s=o.event.clientY;(0,e.dragDisable)(o.event.view),(0,h.nopropagation)(),t.mouse=[u,this.__zoom.invert(u)],(0,i.interrupt)(this),t.start()}}function S(){if(y.apply(this,arguments)){var t=this.__zoom,e=(0,o.mouse)(this),n=t.invert(e),i=t.k*(o.event.shiftKey?.5:2),u=z(D(E(t,i),e,n),_.apply(this,arguments),b);(0,h.default)(),M>0?(0,o.select)(this).transition().duration(M).call(Y,u,e):(0,o.select)(this).call(P.transform,u)}}function A(){if(y.apply(this,arguments)){var t,e,n,u,r=o.event.touches,s=r.length,c=B(this,arguments,o.event.changedTouches.length===s);for((0,h.nopropagation)(),e=0;e<s;++e)n=r[e],u=[u=(0,o.touch)(this,r,n.identifier),this.__zoom.invert(u),n.identifier],c.touch0?c.touch1||c.touch0[2]===u[2]||(c.touch1=u,c.taps=0):(c.touch0=u,t=!0,c.taps=1+!!a);a&&(a=clearTimeout(a)),t&&(c.taps<2&&(a=setTimeout(function(){a=null},q)),(0,i.interrupt)(this),c.start())}}function H(){if(this.__zooming){var t,e,n,i,u=B(this,arguments),r=o.event.changedTouches,s=r.length;for((0,h.default)(),a&&(a=clearTimeout(a)),u.taps=0,t=0;t<s;++t)e=r[t],n=(0,o.touch)(this,r,e.identifier),u.touch0&&u.touch0[2]===e.identifier?u.touch0[0]=n:u.touch1&&u.touch1[2]===e.identifier&&(u.touch1[0]=n);if(e=u.that.__zoom,u.touch1){var c=u.touch0[0],l=u.touch0[1],f=u.touch1[0],m=u.touch1[1],p=(p=f[0]-c[0])*p+(p=f[1]-c[1])*p,v=(v=m[0]-l[0])*v+(v=m[1]-l[1])*v;e=E(e,Math.sqrt(p/v)),n=[(c[0]+f[0])/2,(c[1]+f[1])/2],i=[(l[0]+m[0])/2,(l[1]+m[1])/2]}else{if(!u.touch0)return;n=u.touch0[0],i=u.touch0[1]}u.zoom("touch",z(D(e,n,i),u.extent,b))}}function W(){if(this.__zooming){var t,e,n=B(this,arguments),i=o.event.changedTouches,u=i.length;for((0,h.nopropagation)(),c&&clearTimeout(c),c=setTimeout(function(){c=null},q),t=0;t<u;++t)e=i[t],n.touch0&&n.touch0[2]===e.identifier?delete n.touch0:n.touch1&&n.touch1[2]===e.identifier&&delete n.touch1;if(n.touch1&&!n.touch0&&(n.touch0=n.touch1,delete n.touch1),n.touch0)n.touch0[1]=this.__zoom.invert(n.touch0[0]);else if(n.end(),2===n.taps){var r=(0,o.select)(this).on("dblclick.zoom");r&&r.apply(this,arguments)}}}return P.transform=function(t,e,n){var o=t.selection?t.selection():t;o.property("__zoom",m),t!==o?Y(t,e,n):o.interrupt().each(function(){B(this,arguments).start().zoom(null,"function"==typeof e?e.apply(this,arguments):e).end()})},P.scaleBy=function(t,e,n){P.scaleTo(t,function(){return this.__zoom.k*("function"==typeof e?e.apply(this,arguments):e)},n)},P.scaleTo=function(t,e,n){P.transform(t,function(){var t=_.apply(this,arguments),o=this.__zoom,i=null==n?V(t):"function"==typeof n?n.apply(this,arguments):n,u=o.invert(i),r="function"==typeof e?e.apply(this,arguments):e;return z(D(E(o,r),i,u),t,b)},n)},P.translateBy=function(t,e,n){P.transform(t,function(){return z(this.__zoom.translate("function"==typeof e?e.apply(this,arguments):e,"function"==typeof n?n.apply(this,arguments):n),_.apply(this,arguments),b)})},P.translateTo=function(t,e,n,o){P.transform(t,function(){var t=_.apply(this,arguments),i=this.__zoom,u=null==o?V(t):"function"==typeof o?o.apply(this,arguments):o;return z(s.identity.translate(u[0],u[1]).scale(i.k).translate("function"==typeof e?-e.apply(this,arguments):-e,"function"==typeof n?-n.apply(this,arguments):-n),t,b)},o)},X.prototype={start:function(){return 1==++this.active&&(this.that.__zooming=this,this.emit("start")),this},zoom:function(t,e){return this.mouse&&"mouse"!==t&&(this.mouse[1]=e.invert(this.mouse[0])),this.touch0&&"touch"!==t&&(this.touch0[1]=e.invert(this.touch0[0])),this.touch1&&"touch"!==t&&(this.touch1[1]=e.invert(this.touch1[0])),this.that.__zoom=e,this.emit("zoom"),this},end:function(){return 0==--this.active&&(delete this.that.__zooming,this.emit("end")),this},emit:function(t){(0,o.customEvent)(new r.default(P,t,this.that.__zoom),k.apply,k,[t,this.that,this.args])}},P.wheelDelta=function(t){return arguments.length?(g="function"==typeof t?t:(0,u.default)(+t),P):g},P.filter=function(t){return arguments.length?(y="function"==typeof t?t:(0,u.default)(!!t),P):y},P.touchable=function(t){return arguments.length?(w="function"==typeof t?t:(0,u.default)(!!t),P):w},P.extent=function(t){return arguments.length?(_="function"==typeof t?t:(0,u.default)([[+t[0][0],+t[0][1]],[+t[1][0],+t[1][1]]]),P):_},P.scaleExtent=function(t){return arguments.length?(x[0]=+t[0],x[1]=+t[1],P):[x[0],x[1]]},P.translateExtent=function(t){return arguments.length?(b[0][0]=+t[0][0],b[1][0]=+t[1][0],b[0][1]=+t[0][1],b[1][1]=+t[1][1],P):[[b[0][0],b[0][1]],[b[1][0],b[1][1]]]},P.constrain=function(t){return arguments.length?(z=t,P):z},P.duration=function(t){return arguments.length?(M=+t,P):M},P.interpolate=function(t){return arguments.length?(T=t,P):T},P.on=function(){var t=k.on.apply(k,arguments);return t===k?P:t},P.clickDistance=function(t){return arguments.length?(O=(t=+t)*t,P):Math.sqrt(O)},P}
},{"d3-dispatch":"D3zY","d3-drag":"kkdU","d3-interpolate":"k9aH","d3-selection":"//ys","d3-transition":"UqVV","./constant.js":"CjNr","./event.js":"UMU7","./transform.js":"0OLQ","./noevent.js":"BxLv"}],"MHdZ":[function(require,module,exports) {
...
},{"./zoom.js":"LZWf","./transform.js":"0OLQ"}],"16/U":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=a(require("./edge.js")),t=require("../utils/tools.js"),n=require("../utils/path.js"),i=r(require("d3-selection")),o=r(require("d3-zoom"));function r(e){if(e&&e.__esModule)return e;var t={};if(null!=e)for(var n in e)if(Object.prototype.hasOwnProperty.call(e,n)){var i=Object.defineProperty&&Object.getOwnPropertyDescriptor?Object.getOwnPropertyDescriptor(e,n):{};i.get||i.set?Object.defineProperty(t,n,i):t[n]=e[n]}return t.default=e,t}function a(e){return e&&e.__esModule?e:{default:e}}function s(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function d(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}function l(e,t,n){return t&&d(e.prototype,t),n&&d(e,n),e}var u=function(e){return"string"==typeof e},c="graph",h="edges",f="virtual-edge",g={style:{strokeDasharray:8,stroke:"#888"}},p=function(){function r(t){var n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};s(this,r),this.selectors=t,this.nodes=[],this.edges=[],this.edge={},this.options=n,this.container=this.querySelector(t),this.nodeGroup=this.createGroup(c),this.edgeGroup=this.createGroup(h),this.virtualGroup=this.createGroup(f),this.virtualEdge=new e.default(g),this.createExtraElement(),this.watchProperty(n),Object.assign(this.container.style,this.options.style)}return l(r,[{key:"watchProperty",value:function(e){var t=this,n=e.mode;this.modeHandler(n);var i=n;Object.defineProperty(this,"mode",{enumerable:!0,get:function(){return i},set:function(e){if("render-mode"!==e&&"link-mode"!==e)throw Error("".concat(v," is invalid mode."));t.modeHandler(e),i=e}})}},{key:"modeHandler",value:function(e){"link-mode"===e?this.bindMouseEvent():"render-mode"===e&&this.unBindMouseEvent()}},{key:"querySelector",value:function(e){if(u(e))return document.querySelector(e);throw TypeError("selectors ".concat(e," is not string"))}},{key:"zoom",value:function(){var e=i.select(this.selectors),t=i.selectAll("g").filter(".graph, .edges"),n=o.zoom().scaleExtent([.5,8]).on("zoom",function(){t.attr("transform",i.event.transform)});e.call(n).on("dblclick.zoom",null),this.mode="render-mode"}},{key:"zoomClose",value:function(){i.select(this.selectors).call(o.zoom()).on("wheel.zoom",null).on("mousedown.zoom",null).on("dblclick.zoom",null),this.mode=this.options.mode}},{key:"createGroup",value:function(e){var n=(0,t.creatSvgElement)("g");return n.setAttribute("class",e),this.container.appendChild(n),n}},{key:"bindMouseEvent",value:function(){this.container.onmousemove=this.handleSvgMouseMove.bind(this),this.container.onmouseup=this.handleSvgMouseUp.bind(this)}},{key:"unBindMouseEvent",value:function(){this.container.onmousemove=null,this.container.onmouseup=null}},{key:"handleSvgMouseMove",value:function(e){this.handleDragNode(e),this.handleLinkNode(e)}},{key:"handleSvgMouseUp",value:function(){this.handleLinkNodeOver(),this.initializeLinkEnv()}},{key:"handleDragNode",value:function(e){var t=this,i=this.nodes.find(function(e){return!0===e.mousedownNode});if(i){var o=e.movementX,r=e.movementY,a=i.position,s=a.x,d=a.y;i.position={x:s+o,y:d+r},(0,n.getRectWH)(i.style),this.edges.length>0&&this.edges.forEach(function(e){return e.lineData=t.edgeData(e),e})}}},{key:"handleLinkNode",value:function(t){var n=this.nodes.find(function(e){return""!==e.dotLink});if(n){console.log("start link.."),this.changeMouseStyle("start");var i={};"line"in this.options&&"style"in this.options.line&&(i=this.options.line.style),this.edge=new e.default({style:i}),this.edge.source=n.id,this.edge.dotLink=n.dotLink,this.virtualGroup.appendChild(this.virtualEdge.edge),this.virtualEdge.lineData=this.caclPathDragData(n,t)}}},{key:"changeMouseStyle",value:function(e){var t="initial";"start"===e&&(t="crosshair"),Object.assign(this.container.style,{cursor:t})}},{key:"handleLinkNodeOver",value:function(){var e=this.nodes.find(function(e){return""!==e.dotEndLink});e&&(console.log("end link."),this.changeMouseStyle("end"),this.edges.find(function(t){return t.target===e.id})||!1||(this.edge.target=e.id,this.edge.dotEndLink=e.dotEndLink,this.edge.lineData=this.edgeData(this.edge),this.edges.push(this.edge),this.edgeGroup.appendChild(this.edge.edge)),e.dotEndLink="")}},{key:"initializeLinkEnv",value:function(){var e=this;this.nodes.forEach(function(t){return t.mousedownNode&&(t.mousedownNode=!1),t.linkActive&&(t.linkActive=!1,t.dotLink="",e.virtualGroup.hasChildNodes()&&e.virtualGroup.removeChild(e.virtualEdge.edge)),t})}},{key:"caclPathDragData",value:function(e,t){var n=t.x,i=t.y,o=e.linkNode,r=e.dotLink,a=o[r].x,s=o[r].y;return"M ".concat(a,",").concat(s," L ").concat(n,",").concat(i)}},{key:"edgeData",value:function(e){var t=e.dotLink,i=e.dotEndLink;if(e.source&&e.target){var o=this.nodes.find(function(t){return t.id===e.source}),r=o.linkNode,a=o.y,s=this.nodes.find(function(t){return t.id===e.target}).linkNode,d={dotLink:t,dotEndLink:i,startX:r[t].x,startY:r[t].y,endX:s[i].x,endY:s[i].y},l=(0,n.handleTheSameLinkDot)(d);return""!==l?l:"top"!==t&&"bottom"!==t&&"top"!==i&&"bottom"!==i?this.linkDotIsLeftOrRight(d,e,a):"left"!==t&&"right"!==t&&"left"!==i&&"right"!==i?this.linkDotIsTopOrBottom(d):this.linkDotIsOthers(d)}}},{key:"linkDotIsLeftOrRight",value:function(e,t,i){var o=e.startX,r=e.startY,a=e.endX,s=e.endY,d=(0,n.handleTheSameLinkDot)(e);if(""!==d)return d;var l=(0,n.handelNotSameLinkDotAndAlongColStraightLine)(e);if(""!==l)return l;Math.abs(r-s)<3&&(s=r,this.nodes.forEach(function(e){if(e.id===t.target)return e.y=i,e}));var u=(0,n.getMidXPath)(o,r,a,s),c=u.midX1,h=u.midY1,v=u.midX2,f=u.midY2;return"M ".concat(o,",").concat(r," L ").concat(c,",").concat(h," L ").concat(v,",").concat(f," L ").concat(a,",").concat(s)}},{key:"linkDotIsTopOrBottom",value:function(e){var t=e.startX,i=e.startY,o=e.endX,r=e.endY,a=(0,n.handleTheColSameLinkDot)(e);if(""!==a)return a;var s=(0,n.handleNotSameLinkDotAndAlongStraightLine)(e);if(""!==s)return s;o=(0,n.getFittedEndX)(t,o);var d=(0,n.getMidYPath)(t,i,o,r),l=d.midX1,u=d.midY1,c=d.midX2,h=d.midY2;return"M ".concat(t,",").concat(i," L ").concat(l,",").concat(u," L ").concat(c,",").concat(h," L ").concat(o,",").concat(r)}},{key:"linkDotIsOthers",value:function(e){var t=e.startX,n=e.startY,i=e.endX,o=e.endY;return"M ".concat(t,",").concat(n," L ").concat(i,",").concat(o)}},{key:"createExtraElement",value:function(){var e=(0,t.creatSvgElement)("defs"),n=(0,t.creatSvgElement)("marker"),i=(0,t.creatSvgElement)("path");if(n.setAttribute("id","mark-arrow"),n.setAttribute("refX","8"),n.setAttribute("refY","6"),n.setAttribute("orient","auto"),n.setAttribute("viewBox","0 0 11 11"),n.setAttribute("markerWidth","10"),n.setAttribute("markerHeight","10"),i.setAttribute("d","M1,2 L8,6 L1,10 Z"),"line"in this.options&&"arrow"in this.options.line){var o=this.options.line;"style"in o.arrow&&Object.assign(i.style,o.arrow.style),"d"in o.arrow&&u(o.arrow.d)&&i.setAttribute("d",o.arrow.d),"viewBox"in o.arrow&&u(o.arrow.viewBox)&&n.setAttribute("viewBox",o.arrow.viewBox)}n.appendChild(i),e.appendChild(n),this.container.appendChild(e);var r=document.createElement("style");r.setAttribute("class","flowchart-core-style");var a=document.querySelector("head");"link-mode"===this.mode&&(r.innerText="\n                .link-dot:hover {\n                    r: 12px!important;\n                    stroke: red!important;\n                    fill: transparent!important;\n                }\n            ");var s=this.options.linkDot||{},d=s.r,l=void 0===d?2:d,c=s.fill,h=void 0===c?"#000":c,v=s.stroke,f=void 0===v?"#000":v,g=s.strokeWidth,p=void 0===g?2:g,m=s.display,k=void 0===m?"unset":m;r.innerText+="\n                .link-dot {\n                    r: ".concat(l,"px;\n                    fill: ").concat(h,";\n                    stroke: ").concat(f,";\n                    stroke-width: ").concat(p,"px;\n                    transition: all 0.2s ease-in-out;\n                    display: ").concat(k,";\n                }\n            "),document.querySelector(".flowchart-core-style")||a.appendChild(r)}},{key:"addNode",value:function(e){this.nodes.push(e),this.nodeGroup.appendChild(e.node)}},{key:"addEdge",value:function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};Object.assign(e,t),e.lineData=this.edgeData(e),this.edges.push(e),this.edgeGroup.appendChild(e.edge)}},{key:"deleteNode",value:function(e){var t=this.nodes.findIndex(function(t){return t.id===e.id});-1!==t&&(this.nodes.splice(t,1),this.nodeGroup.removeChild(e.node))}},{key:"deleteEdge",value:function(e){var t=this.edges.findIndex(function(t){return t.id===e.id});-1!==t&&(this.edges.splice(t,1),this.edgeGroup.removeChild(e.edge))}},{key:"hiddenSvgElement",value:function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"node";if(!(t in e))throw TypeError("type value must be 'node' or 'edge', '".concat(t,"' is not one of them"));Object.assign(e[t].style,{display:"none"})}},{key:"showSvgElement",value:function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"node";if(!(t in e))throw TypeError("type value must be 'node' or 'edge', '".concat(t,"' is not one of them"));Object.assign(e[t].style,{display:"unset"})}}]),r}();exports.default=p;
},{"./edge.js":"aLLG","../utils/tools.js":"hLGD","../utils/path.js":"mxbm","d3-selection":"//ys","d3-zoom":"MHdZ"}],"NZjl":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var t=require("../utils/tools.js");function e(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function i(t,e){for(var i=0;i<e.length;i++){var n=e[i];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}function n(t,e,n){return e&&i(t.prototype,e),n&&i(t,n),t}var o=function(){function i(t){e(this,i);var n=t.style,o=void 0===n?{}:n,s=t.html,a=void 0===s?{}:s;this.node={},this.html=a,this.style=Object.assign({width:140,height:70,strokeWidth:2,stroke:"black",fill:"transparent"},o),this.dotLink="",this.dotEndLink="",this.mousedownNode=!1,this.linkActive=!1,this.linkNode={},this.watchProperty(t),this.initializeNode()}return n(i,[{key:"watchProperty",value:function(e){var i=this;if(!("position"in e))throw Error("There must be have a position attribute in config Object");var n=e.position,o=(0,t.getRandomStr)();Object.defineProperties(this,{position:{enumerable:!0,get:function(){return n},set:function(t){n=t,i.handlePositionChange(t)}},id:{enumerable:!0,get:function(){return o},set:function(t){if("string"!=typeof t)throw TypeError("".concat(t," is not a string"));o=t}}})}},{key:"changePosition",value:function(t){if(!("x"in t||"y"in t))throw Error("There must be have x or y attribute in position Object");this.position=Object.assign({},this.position,t)}},{key:"handlePositionChange",value:function(t){var e=t.x,i=t.y;this.node.style.transform="translate(".concat(e,"px, ").concat(i,"px)"),this.initialLinkNodeData()}},{key:"initialLinkNodeData",value:function(){var t=this.style,e=t.width,i=t.height,n=this.position,o=n.x,s=n.y,a=o+e/2,r=s+i/2;this.linkNode={top:{x:a,y:s},bottom:{x:a,y:s+i},left:{x:o,y:r},right:{x:o+e,y:r}}}},{key:"initializeNode",value:function(){this.node=this.createNode(this.style)}},{key:"createNode",value:function(e){var i=(0,t.creatSvgElement)("g");if(i.setAttribute("class","node-container"),"meta"in this.html&&this.html.meta){var n=(0,t.creatSvgElement)("foreignObject");n.setAttribute("class","node"),n.appendChild(this.html.meta),n=this.initialNodeStyle(n,e),i.appendChild(n)}else{var o=(0,t.creatSvgElement)("rect");o.setAttribute("class","node"),o=this.initialNodeStyle(o,e),i.appendChild(o)}var s=this.position,a=s.x,r=s.y;return i.style.transform="translate(".concat(a,"px, ").concat(r,"px)"),i=this.initializeLinkDot(i,e),i=this.nodeBindMouseEvent(i)}},{key:"nodeBindMouseEvent",value:function(t){return t.onmousedown=this.dragSvgNode.bind(this),t}},{key:"dragSvgNode",value:function(){this.linkActive||(this.mousedownNode=!0)}},{key:"initialNodeStyle",value:function(t,e){return Object.assign(t.style,e),t}},{key:"initializeLinkDot",value:function(e,i){var n=(0,t.creatSvgElement)("circle"),o=(0,t.creatSvgElement)("circle"),s=(0,t.creatSvgElement)("circle"),a=(0,t.creatSvgElement)("circle");n.setAttribute("class","link-dot top"),o.setAttribute("class","link-dot bottom"),s.setAttribute("class","link-dot left"),a.setAttribute("class","link-dot right");var r=i.width,d=i.height,l=r/2,h=d/2;Object.assign(n.style,{cx:l+"px",cy:0}),Object.assign(o.style,{cx:l+"px",cy:d+"px"}),Object.assign(s.style,{cx:0,cy:h+"px"}),Object.assign(a.style,{cx:r+"px",cy:h+"px"});var c=this.dotBindMouseEvent({topDot:n,bottomDot:o,leftDot:s,rightDot:a});return e.appendChild(c.topDot),e.appendChild(c.bottomDot),e.appendChild(c.leftDot),e.appendChild(c.rightDot),this.initialLinkNodeData(),e}},{key:"dotBindMouseEvent",value:function(t){var e=t.topDot,i=t.bottomDot,n=t.leftDot,o=t.rightDot;return e.onmousedown=this.startLinkNode.bind(this,"top"),i.onmousedown=this.startLinkNode.bind(this,"bottom"),n.onmousedown=this.startLinkNode.bind(this,"left"),o.onmousedown=this.startLinkNode.bind(this,"right"),e.onmouseup=this.endLinkedNode.bind(this,"top"),i.onmouseup=this.endLinkedNode.bind(this,"bottom"),n.onmouseup=this.endLinkedNode.bind(this,"left"),o.onmouseup=this.endLinkedNode.bind(this,"right"),{topDot:e,bottomDot:i,leftDot:n,rightDot:o}}},{key:"startLinkNode",value:function(t){this.linkActive=!0,this.mousedownNode=!1,this.dotLink=t}},{key:"endLinkedNode",value:function(t){""===this.dotLink&&(this.linkActive=!0,this.mousedownNode=!1,this.dotEndLink=t)}}]),i}();exports.default=o;
...
},{"./core.js":"16/U","./graph.js":"NZjl","./edge.js":"aLLG"}],"YHps":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var t=require("../core/index.js"),i=require("../utils/tools.js");function n(t){return o(t)||r(t)||e()}function e(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function r(t){if(Symbol.iterator in Object(t)||"[object Arguments]"===Object.prototype.toString.call(t))return Array.from(t)}function o(t){if(Array.isArray(t)){for(var i=0,n=new Array(t.length);i<t.length;i++)n[i]=t[i];return n}}function a(t,i){if(!(t instanceof i))throw new TypeError("Cannot call a class as a function")}function d(t,i){for(var n=0;n<i.length;n++){var e=i[n];e.enumerable=e.enumerable||!1,e.configurable=!0,"value"in e&&(e.writable=!0),Object.defineProperty(t,e.key,e)}}function c(t,i,n){return i&&d(t.prototype,i),n&&d(t,n),t}var s=function(){function e(t,i){a(this,e);var n=i.data,r=i.coreOptions,o=void 0===r?{}:r,d=i.direction,c=void 0===d?"y-axis":d;this.nodes=this.initData(n),this.core={},this.coreOptions=o,this.direction=c,this.init(t,i)}return c(e,[{key:"initData",value:function(t){if("Array"===(0,i.typeOf)(t))return t.map(function(t){return"position"in t||(t.position={x:50,y:50}),t});throw TypeError("".concat(t," is not Array"))}},{key:"init",value:function(i,n){var e=n.zoom,r=void 0!==e&&e,o=n.coreOptions,a=void 0===o?{}:o,d={linkDot:{display:"none"}};Object.assign(d,a,{mode:"render-mode"}),this.core=new t.Core(i,d),this.initialLayout(this.nodes),r&&this.core.zoom(i)}},{key:"initialLayout",value:function(t){var i=this,e=this.findRoot(t);-1===this.core.nodes.findIndex(function(t){return t.id===e.id})&&this.createNode(e);var r=t.filter(function(t){return t.parent===e.id}),o=[];r.forEach(function(t){if(t.parent===e.id&&t.children.length>0){var a=r.filter(function(i){return-1!==t.children.indexOf(i.id)}),d=i.findChilds(i.nodes,t);a=Array.from(new Set([t].concat(n(a),n(d)))),o.push(a)}});var a=0;r.forEach(function(t,n){var r=i.createNode(t),o=t.children.length;if(o>=1){var d=i.nodes.filter(function(i){if(-1!==t.children.indexOf(i.id))return i}).reduce(function(t,i){return i.children.length>0?t+i.children.length:t},0),c=i.getPosition(t,e,a);r.changePosition(c),a+=o>1?o+d:1}else{var s=i.getPosition(t,e,n);r.changePosition(s),a+=1}}),this.drawLink(r,e),o.length>0&&o.forEach(function(t){i.initialLayout(t)})}},{key:"findRoot",value:function(t){return t.find(function(i){if(i.children.length>0)return-1===t.findIndex(function(t){return i.parent===t.id})})}},{key:"findChilds",value:function(t,i){var e=this,r=[],o=t.filter(function(n){if(n.parent===i.id)return n.children.length>0&&(r=e.findChilds(t,n)),n});return Array.from(new Set([].concat(n(o),n(r))))}},{key:"getPosition",value:function(t,i,n){var e=t.width,r=t.height,o=this.direction;if(0===e||0===r||void 0===e||void 0===r)throw Error('node must has "width" an "height" attributes');var a=2*e,d=2*r,c=i.position,s=c.x,u=c.y,h=0,f=0;return"y-axis"===o?(h=s+a*n,f=u+d):"x-axis"===o&&(h=s+a,f=u+d*n),t.position={x:h,y:f},t.position}},{key:"createNode",value:function(i){var n='.item[data-rsgraph-id="'.concat(i.id,'"]'),e=document.querySelector(n),r=i.width,o=void 0===r?0:r,a=i.height,d=void 0===a?0:a,c=i.position;if(0===o||0===d||void 0===o||void 0===d)throw Error('node must has "width" an "height" attributes');var s=new t.Node({position:c,style:{width:o,height:d,userSelect:"none",rx:10},html:{meta:e}});return Object.assign(s,i),this.core.addNode(s),s}},{key:"drawLink",value:function(i,n){var e=this,r=this.coreOptions.line.style,o=void 0===r?{}:r,a="bottom",d="top";"x-axis"===this.direction&&(a="right",d="left"),i.forEach(function(i){var r=new t.Edge({style:o});e.core.addEdge(r,{source:n.id,target:i.id,dotLink:a,dotEndLink:d})})}}]),e}();exports.default=s;
},{"../core/index.js":"0rqM","../utils/tools.js":"hLGD"}],"XC3i":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),Object.defineProperty(exports,"RSGraph",{enumerable:!0,get:function(){return e.default}});var e=r(require("./RSGraph.js"));function r(e){return e&&e.__esModule?e:{default:e}}
},{"./RSGraph.js":"YHps"}],"Focm":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),Object.defineProperty(exports,"Core",{enumerable:!0,get:function(){return e.Core}}),Object.defineProperty(exports,"Node",{enumerable:!0,get:function(){return e.Node}}),Object.defineProperty(exports,"Edge",{enumerable:!0,get:function(){return e.Edge}}),Object.defineProperty(exports,"RSGraph",{enumerable:!0,get:function(){return r.RSGraph}});var e=require("./core/index.js"),r=require("./layout/index.js");window.Core=e.Core,window.Node=e.Node,window.Edge=e.Edge,window.RSGraph=r.RSGraph;
},{"./core/index.js":"0rqM","./layout/index.js":"XC3i"}]},{},["Focm"], "flowchart-core")